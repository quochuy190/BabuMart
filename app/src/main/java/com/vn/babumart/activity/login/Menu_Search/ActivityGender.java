...
import com.vn.babumart.adapter.AdapterGender;
...
public class ActivityGender extends BaseActivity
    ...
    private List<Gender> mList;
    private AdapterGender adapterService;
    ...
    private void init() {
        mList = new ArrayList<>();
        temp = new ArrayList<>();
        adapterService = new AdapterGender(temp, this);
    ...
    private void initData() {
        temp.clear();
        mList.clear();
        mList.add(new Gender("Nam", "1"));
        mList.add(new Gender("Nữ", "2"));
        temp.addAll(mList);
